...
urlpatterns = [
    ...
    path('upload-user-work/', views.update_work_user, name='update_work_user'),
    ...
    path('update-height-user/', views.update_height_user, name='update_height_user'),
    path('update-language-user/', views.update_language_user, name='update_language_user'),
    path('update-zodiac-user/', views.update_zodiac_user, name='update_zodiac_user'),
    path('update-zheme-user/', views.update_theme, name='update_theme'),
    ...
    path('save-user-interest-database/', views.save_interests, name='save_interests'),
